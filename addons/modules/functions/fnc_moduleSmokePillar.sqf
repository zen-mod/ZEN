/*
 * Author: mharis001
 * Creates a persistent smoke pillar of given type.
 * Smoke templates are from: https://community.bistudio.com/wiki/ParticleTemplates.
 *
 * Arguments:
 * 0: Logic <OBJECT>
 * 1: Smoke pillar type <NUMBER>
 *
 * Return Value:
 * None
 *
 * Example:
 * [LOGIC, 0] call zen_modules_fnc_moduleSmokePillar
 *
 * Public: No
 */
#include "script_component.hpp"

params ["_logic", "_smokeType"];
TRACE_1("Module Smoke Pillar",_this);
